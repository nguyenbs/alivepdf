...
public class DateFormatter
{
     ...
     *  
     *  @see supportClasses.formatters.DateBase
     * 
    ...
    private static var defaultInvalidValueError:String = "Invalid value";
    private static var defaultInvalidFormatError:String = "Invalid format";
